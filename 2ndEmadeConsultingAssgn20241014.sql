/**********************************************************************************************************************
DEVELOPER: Rekiat Ozigi
DATE CREATED: 2024-11-14
CODE VERSION: 1.0
DESCRIPTION: THIS CODE PROVIDES INFORMATION ABOUT MEMBER DETAILS: NAME, AGE, MEDICAL RECORD NUMBER, ADDRESS & PHONE NUMBER
NOTES: THIS FIELD:PRSN_IK IS THE PRIMARY KEY OR UNIQUE KEY WHICH IDENTIFIES A EACH MEMBER
...
--create Table
CREATE TABLE Emade_consultingEMPLOYEE
(
...
--LOAD DATA TO THE TABLES
INSERT INTO Emade_consultingEMPLOYEE
VALUES
...
JOIN [dbo].[Emade_consultingEMPLOYEE] AS E
...
FROM [dbo].[Emade_consultingEMPLOYEE]
WHERE Salary =
(
...
FROM [dbo].[Emade_consultingEMPLOYEE] AS E
JOIN[dbo].[EmadeconsultingDEPARTMENT] AS D 
ON E.Department_ID = D.DEPARTMENT_ID
WHERE D.NAME = 'Sales'
Group BY Name
